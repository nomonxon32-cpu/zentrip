import { BookingPaymentStatus, BookingStatus, BookingType, Role, VehicleStatus } from "@prisma/client";
...
export async function POST(request: Request) {
  try {
    ...
    // Cash-only flow: no online payment is taken at booking time. The booking is
    // created as a request awaiting owner approval, and money is collected in
    // cash at pickup. paymentStatus stays UNPAID until that happens.
