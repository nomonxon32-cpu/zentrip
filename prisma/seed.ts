    ...
    data: [
      {
        ...
        userId: renterDemo.id,
        amount: completedBooking.rentalAmount,
      ...
      },
      {
        ...
        userId: renterDemo.id,
        amount: pendingApprovalBooking.rentalAmount,
        type: PaymentType.RENTAL_PAYMENT,
      ...
      },
      {
        ...
        userId: renterTwo.id,
        amount: confirmedBooking.rentalAmount,
        type: PaymentType.RENTAL_PAYMENT,
      ...
      },
      {
        ...
        userId: renterDemo.id,
        amount: activeBooking.rentalAmount,
        type: PaymentType.RENTAL_PAYMENT,
      ...
      },
      {
        ...
        userId: renterDemo.id,
        amount: cancelledBooking.rentalAmount,
        type: PaymentType.RENTAL_PAYMENT,
      ...
      },
      {
        ...
        userId: renterTwo.id,
        amount: disputedBooking.rentalAmount,
        type: PaymentType.RENTAL_PAYMENT,
